...
function Modal() {
    ...
    const uploadPost = async( ) => {
        ...
        //Crate a post and add to firesotre collaction post
        // get the post ID for the newly created post
        // upload the iamge to firebase sotrae with the post ID
        // get a dowload URL from fb storage and update and original post with image
